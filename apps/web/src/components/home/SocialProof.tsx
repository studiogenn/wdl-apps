...
import { ClockIcon, UsersThreeIcon, PackageIcon } from "@phosphor-icons/react";

const STATS = [
  { icon: ClockIcon, value: "24 Hour", label: "Turnaround" },
  { icon: UsersThreeIcon, value: "9,000+", label: "Happy Customers" },
  { icon: PackageIcon, value: "1M+", label: "Lbs Cleaned" },
];
  ...
  return (
    <section className="bg-cream py-16 lg:py-20">
      <div className="container-site max-w-[1100px]">
        {/* Stats row */}
        <div className="flex flex-wrap items-center justify-center gap-8 sm:gap-12 lg:gap-16 mb-12 lg:mb-14">
          {STATS.map((stat) => (
            <div key={stat.label} className="flex items-center gap-3">
              <stat.icon size={28} weight="duotone" className="text-primary shrink-0" />
              <div>
                <p className="font-[family-name:var(--font-poppins)] text-lg font-body-medium text-navy leading-tight">
                  {stat.value}
                </p>
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="font-[family-name:var(--font-poppins)] text-xs text-navy/50">
              5.0 on Google
            </span>
          </div>
        </div>
