        ...
        <div className="container-site max-w-[1000px]">
          <div className="flex flex-col md:flex-row gap-4 justify-center">
            <div className="bg-primary text-white rounded-full px-8 py-6 text-center min-w-[280px]">
              <h2 className="font-[family-name:var(--font-poppins)] text-base font-semibold mb-1">
                Phone Number:
              </h2>
              <a
                href="tel:8559685511"
                className="font-[family-name:var(--font-poppins)] text-sm hover:underline"
              >
                (855) 968-5511
              </a>
            </div>
    ...
    <form onSubmit={handleSubmit} className="bg-white rounded-2xl p-8 lg:p-10 space-y-5 shadow-sm">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <input
          ...
          required
          className="font-[family-name:var(--font-poppins)] px-4 py-3 text-sm bg-gray-50 border-0 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary"
        />
        <input
          type="text"
          name="last_name"
      ...
      <input
        ...
        className="font-[family-name:var(--font-poppins)] w-full px-4 py-3 text-sm bg-gray-50 border-0 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary"
      />
      <textarea
        name="message"
        placeholder="Please enter your questions, comments, or concerns in this field"
        rows={5}
        className="font-[family-name:var(--font-poppins)] w-full px-4 py-3 text-sm bg-gray-50 border-0 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary resize-none"
      />
      ...
      <button
        ...
        className="font-[family-name:var(--font-inter)] w-full px-8 py-3.5 text-sm font-semibold text-white bg-primary rounded-full hover:bg-primary-hover transition-colors disabled:opacity-50"
      >
      ...
      <p className="text-center font-[family-name:var(--font-poppins)] text-xs text-navy/50 mt-4">
